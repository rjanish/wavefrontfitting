                             ...
                             char* file_name)
{
     ...
     param_guesses[5] = 0.5;                 // seeing
     param_guesses[6] = tilt_x[0];           // +
     param_guesses[7] = tilt_y[0];           // +  
     param_guesses[8] = defocus[0];          // +
     param_guesses[9] = flux[0];             // +
     param_guesses[10] = bkgnd[0];           // +
     param_guesses[11] = tilt_x[1];          // -
     param_guesses[12] = tilt_y[1];          // -
     param_guesses[13] = (-1)*defocus[1];    // -
